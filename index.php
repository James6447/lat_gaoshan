                    ...
                    <div class="slides">
                        <div class="slide is-active ">
                            <div class="slide-content">
                                <div class="caption">
                                    <div class="title trn" data-trn-key="To Find Up Your Tire">To Find Up Your Tire</div>
                                    <div class="text trn" data-trn-key="Check the suitable tire for your car">
                                        <p>Check the suitable tire for your car</p>
                                    </div>
                                    <a id="v-btn1" href="#" class="button">
                                        <span class="btn-inner trn" data-trn-key="Learn More">Learn More</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="slide">
                            <div class="slide-content">
                                <div class="caption">
                                    <div class="title trn" data-trn-key="Design Your Rim">Design Your Rim</div>
                                    <div class="text trn" data-trn-key="Customized and Embellish your tire rim"> 
                                        <p>Customized and Embellish your tire rim</p>
                                    </div>
                                    <a href="product_new.php" class="button">
                                        <span class="btn-inner trn"  data-trn-key="Learn More">Learn More</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="slide">
                            <div class="slide-content">
                                <div class="caption">
                                    <div class="title trn" data-trn-key="About The Tire">About The Tire</div>
                                    <div class="text trn" data-trn-key="Understanding the basically knowledge of tire">
                        ...
                        <div class="slide">
                            <div class="slide-content">
                                <div class="caption">
                                    <div class="title trn" data-trn-key="Service & Maintain">Service & Maintain</div>
                                    <div class="text trn" data-trn-key="Welcome to visit our store and apply our service">
                                        <p>Welcome to visit our store and apply our service</p>
                                    </div>
                                    <a href="brands.php" class="button">
                                        <span class="btn-inner trn" data-trn-key="Learn More">Learn More</span>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="search-area col-12 col-lg-4">
                <div class="markerarea">
                    ...
                    <div class="markertext">
                        <p class="trn" data-trn-key="Enter your tyre size">Enter your tyre size</p>

                        <form action="product_new.php" method="get">
                            <div class="search-filter">
                                <div class="block space-filter">
                                    <span class="trn" data-trn-key="Width(mm)">Width(mm)</span>
                                    <select class="" name="width">
                                        <option value="" class="trn" data-trn-key="Width(mm)">Width(mm)</option>
                                    </select>
                                </div>
                                ...
                                <div class="block space-filter">
                                    <span class="trn" data-trn-key="Height(mm)">Height(mm)</span>
                                    <select class="is-active" name="height">
                                        <option value=""  class="trn" data-trn-key="Height(mm)">Height(mm)</option>
                                    </select>
                                </div>
                                ...
                                <div class="block space-filter">
                                    <span class="trn" data-trn-key="Diameter(inch)">Diameter(inch)</span>
                                    <select style="max-width:100px"  class="is-active" name="diameter">
                                        <option value="" class="trn" data-trn-key="Diameter(inch)">Diameter(inch)</option>
                                    </select>
                                </div>
                            </div>
                            <div class="search-btn">
                                <button type="submit" class="trn" data-trn-key="Continue">Continue</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div id="cont-1" class="card">
                            <div class="card-body">
                                ...
                                <div class="active-content">
                                    <p class="trn" data-trn-key="slide1">The comfort choice with lowest noise level and smooth comfortable ride.</p>
                                    <a href="#">
                                        <button type="button" onclick="changeTabContent('t-1')"
                                            class="trn btn btn-secondary notext" style="color:#fff" data-toggle="modal"
                                            data-target="#t-1" data-trn-key="More Details">
                                            More Details
                                        </button>
                                    </a>
                    ...
                    <div class="item">
                        <div id="cont-2" class="card">
                            <div class="card-body">
                                ...
                                <div class="active-content">
                                    <p class="trn" data-trn-key="slide2">Highest performance level guaranteed by German Technology. Perfect tyre-contact
                                        to control the vehicle.</p>
                                    <a href="#">
                                        <button type="button" onclick="changeTabContent('t-2')"
                                            class="trn btn btn-secondary notext" style="color:#fff" id="btn2"
                                            data-toggle="modal" data-target="#t-1" data-trn-key="More Details">
                                            More Details
                                        </button>
                                    </a>
                                </div>
                    ...
                    <div class="item">
                        <div id="cont-3" class="card">
                            <div class="card-body">
                                ...
                                <div class="active-content">
                                    <p class="trn" data-trn-key="slide3">Safety on any street. Control at any speed.</p>
                                    <a href="#">
                                        <button type="button" onclick="changeTabContent('t-3')"
                                            class="trn btn btn-secondary notext" style="color:#fff" id="btn3"
                                            data-toggle="modal" data-target="#t-1" data-trn-key="More Details">
                                            More Details
                                        </button>
                                    </a>
                    ...
                    <div class="item">
                        <div id="cont-4" class="card">
                            <div class="card-body">
                                ...
                                <div class="active-content">
                                    <p class="trn" data-trn-key="slide4">Perfect for performance and comfort</p>
                                    <a href="#">
                                        <button type="button" onclick="changeTabContent('t-4')"
                                            class="trn btn btn-secondary notext" id="btn4" style="color:#fff"
                                            data-toggle="modal" data-target="#t-1" data-trn-key="More Details">
                                            More Details
                                        </button>
                                    </a>
                    ...
                    <div class="item">
                        <div id="cont-5" class="card">
                            <div class="card-body">
                                ...
                                <div class="active-content">
                                    <p class="trn" data-trn-key="slide5">The perfect all-round tyre, matching performance with safety.</p>
                                    <a href="#">
                                        <button type="button" onclick="changeTabContent('t-5')"
                                            class="trn btn btn-secondary notext" id="btn5" style="color:#fff"
                                            data-toggle="modal" data-target="#t-1" data-trn-key="More Details">
                                            More Details
                                        </button>
                                    </a>
                    ...
                    <div class="item">
                        <div id="cont-6" class="card">
                            <div class="card-body">
                                ...
                                <div class="active-content">
                                    <p class="trn" data-trn-key="slide6">When MAX Performance Counts</p>
                                    <a href="#">
                                        <button type="button" onclick="changeTabContent('t-6')"
                                            class="trn btn btn-secondary notext" id="btn6" style="color:#fff"
                                            data-toggle="modal" data-target="#t-1" data-trn-key="More Details">
                                            More Details
                                        </button>
                                    </a>
                        ...
                        <form action="#" method="post">
                            <div class="container pt-4 pb-4">
                                <div class="d-inline-block col-md-3">
                                    <p class="trn" data-trn-key="CAR BRANDS">CAR BRANDS</p>
                                    <select id="typeCar" class="maintain" name="carType">
                                        <option value="0" class="trn" data-trn-key="Brands">Brands</option>
                                        <!--车款选项 -->
                                    </select>
                                </div>
                                <div class="d-inline-block col-md-3">
                                    <p class="trn" data-trn-key="CAR MODEL">CAR MODEL</p>
                                    <select id="modelCar" class="maintain" name="carModel">
                                        <!-- 车形选项 -->
                                        <option class="trn" data-trn-key="Model">Model</option>
                                    </select>
                                </div>
