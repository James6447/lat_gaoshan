...
<div class="main-background">
  <div class="main-content">
    ...
    <h1 class="locationtitle"><span class="brand-title"><img src='img/location.png'></span>&nbsp;&nbsp;&nbsp;<span class="trn" data-trn-key="Location">Location</span></h1>
          ...
          <li id="brand1" class="brand brand-1" onmouseover="showImg('img-1')" onmouseout="hideImg('img-1')" onclick="moveToLocation(1.5188448,103.6845604,'brand1')">
            <div class="w60 img">
              ...
              <div class="w-100 pad">
                ...
                <p class="trn" data-trn-key="Address">Address <span class="slash">|</span></p>
                <p>No.1,Jalan Anggerik 3/1,Taman Anggerik.81200,Johor Bahru</p>
                <p class="trn" data-trn-key="Phone">Phone <span class="slash">|</span></p>
