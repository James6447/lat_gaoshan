           ...
           <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">轮胎维护</h5>
        ...
        <div class="card-body ">
          ...
          <div id="myModal1" class="modal fade" data-easein="bounceIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">蓄电池服务</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
        ...
        <div class="card-body ">
          ...
          <div id="myModal2" class="modal fade" data-easein="bounceIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">维护</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              <li>更换火花塞</li>
              <li>调整引擎</li>
              <li>检查液位并重新加注制动液/离合器液</li>
              <li>检查制动蹄片/衬里，制动盘/鼓，如果磨损则更换。</li>
              <li>检查水平并重新填充动力转向液</li>
              <li>检查水平并重新填充自动/手动变速箱油</li>
              <li>润滑和润滑组件</li>
              <li>如果需要，检查并更换同步带或正时链</li>
              <li>检查轮胎的状况</li>
              <li>检查所有灯，刮水器等的正确操作</li>
              <li>检查ECU中的任何错误代码并采取纠正措施。</li>
              <li>清洗车辆并清洁内部。</li>
              <li>使用扫描工具读取故障代码。</li>
              <br><br>
              <span class="message-notice">* 如果以下几个步骤困扰您，请联系我们以获得更专业的服务。<br></span></div>
        ...
        <div class="card-body ">
          ...
          <div id="myModal4" class="modal fade" data-easein="bounceIn"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">检查轮胎</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              此外，您应该每5,000至10,000英里旋转轮胎。定期旋转车轮确保所有轮胎具有相同的磨损模式，从而延长车轮的使用寿命。<br><br>
              最后，当轮胎磨损超过合理限度时更换轮胎，以避免发生任何事故<br><br>
              <span class="message-notice">* 如果以下几个步骤困扰您，请联系我们以获得更专业的服务。<br></span></div>
              <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">关闭</button>
              </div>
