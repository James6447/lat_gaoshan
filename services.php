...
<body onscroll="backTop()">
  ...
  include('header.html');
  ?>
  <h1 class="servicetitle"><span class="brand-title"><img src='img/Service.png'></span>&nbsp;&nbsp;&nbsp;Services</h1>
    ...
    <div class="grid-item">
      <div class="card box-shadow">
        ...
        <div class="card-body ">
          ...
          <p class="card-text">Sometimes a pneumatic tire gets a hole or a leak through which the air inside leaks
            out
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body"><br>
                  ...
                  <span class="message-notice">* If these few following step bothering you, please contact us for
                    more
                    professional services.<br></span>
                  <div class="modal-footer">
                    <div class="felxend">
                      <button type="button" class="close0 btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="grid-item ">
      <div class="card box-shadow">
        ...
        <div class="card-body ">
          ...
          <p class="card-text">Traction is the friction between wheels or tires and the ground that allows a vehicle
          ...
          <div id="myModal1" class="modal fade" data-easein="bounceIn" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="close1 btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="grid-item">
      <div class="card box-shadow">
        ...
        <div class="card-body ">
          ...
          <p class="card-text">A motor vehicle service or tune-up is a series of maintenance procedures carried out
            at
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body"><br>
                  ...
                  modern cars display the due date for the next service electronically on the instrument panel.</br>
